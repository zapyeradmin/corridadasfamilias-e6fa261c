...
// Fallback: se a query atrasar, ainda renderiza o carrossel com as 4 marcas conhecidas
const FALLBACK = [
  { id: "oracle-digital", name: "Oracle Digital", slug: "oracle-digital", website_url: null as string | null },
