    ...
    <section className="bg-[color:var(--color-brand-orange)]">
      <div className="mx-auto max-w-[1200px] px-5 py-20 md:px-8 md:py-28">
        ...
        <Accordion
          type="single"
          collapsible
          className="mt-10 grid gap-4 md:mt-14"
        >
...
type Premio = { lugar: string; texto: string };
type SubCategoria = { genero: "M" | "F"; titulo: string; premios: Premio[] };
type Categoria = { sub: SubCategoria[] };

const PREMIOS_GERAL_M: Premio[] = [
...
const PREMIOS_GERAL_F: Premio[] = [
  { lugar: "1º", texto: "R$ 500,00 + Troféu de Primeiro Lugar + Medalha" },
  { lugar: "2º", texto: "R$ 300,00 + Troféu de Segundo Lugar + Medalha" },
  { lugar: "3º", texto: "R$ 200,00 + Troféu de Terceiro Lugar + Medalha" },
];
const PREMIOS_TROFEU: Premio[] = [
...
function LugarBadge({ lugar }: { lugar: string }) {
  const tone =
    lugar === "1º"
...
function SubCategoriaBlock({ sub }: { sub: SubCategoria }) {
